...
fn main() {
    println!("sum_of_multiples([3, 5], 1000)          = {}", sum_of_multiples(&[3, 5], 1000));
    println!("sum_of_multiples([2,3,5,7,11], 10000)   = {}", sum_of_multiples(&[2, 3, 5, 7, 11], 10000));
    println!("sum_of_multiples([], 1000)               = {}", sum_of_multiples(&[], 1000));
    println!("sum_of_multiples([0, 3], 10)             = {}", sum_of_multiples(&[0, 3], 10));

    println!("\n-- fold variant --");
    println!("sum_of_multiples_fold([3, 5], 1000)      = {}", sum_of_multiples_fold(&[3, 5], 1000));

    println!("\n-- math (inclusion-exclusion) variant --");
    println!("sum_of_multiples_math([3, 5], 1000)      = {}", sum_of_multiples_math(&[3, 5], 1000));
    println!("sum_of_multiples_math([2,3,5,7,11],10000)= {}", sum_of_multiples_math(&[2, 3, 5, 7, 11], 10000));
}
