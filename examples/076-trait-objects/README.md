...
# 076-trait-objects — Trait Objects

See [hightechmind.io/rust/076-trait-objects](https://hightechmind.io/rust/076-trait-objects) for the full explanation, OCaml comparison, and tests.
