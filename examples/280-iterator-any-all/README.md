...
# 280-iterator-any-all — Iterator Any All

See [hightechmind.io/rust/280-iterator-any-all](https://hightechmind.io/rust/280-iterator-any-all) for the full explanation, OCaml comparison, and tests.
