...
# 897-borrowing-shared — Borrowing Shared

See [hightechmind.io/rust/897-borrowing-shared](https://hightechmind.io/rust/897-borrowing-shared) for the full explanation, OCaml comparison, and tests.
