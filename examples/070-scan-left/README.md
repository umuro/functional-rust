...
# 070-scan-left — Scan Left

See [hightechmind.io/rust/070-scan-left](https://hightechmind.io/rust/070-scan-left) for the full explanation, OCaml comparison, and tests.
