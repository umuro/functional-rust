...
# 279-iterator-nth — Iterator Nth

See [hightechmind.io/rust/279-iterator-nth](https://hightechmind.io/rust/279-iterator-nth) for the full explanation, OCaml comparison, and tests.
