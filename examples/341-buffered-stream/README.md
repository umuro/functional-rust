...
# 341-buffered-stream — Buffered Stream

See [hightechmind.io/rust/341-buffered-stream](https://hightechmind.io/rust/341-buffered-stream) for the full explanation, OCaml comparison, and tests.
