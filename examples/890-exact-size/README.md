...
# 890-exact-size — Exact Size

See [hightechmind.io/rust/890-exact-size](https://hightechmind.io/rust/890-exact-size) for the full explanation, OCaml comparison, and tests.
